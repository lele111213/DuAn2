...
class TinhCanChi {
  ...
  static String tinhNgayCanChi(DateTime date) {
    // input là ngày dương
    //baseDate là ngày dương, 03/01/2000 là ngày "Canh Thân", giá trị trong mảnh là: can[0], chi[0]
  ...
  static String tinhThangCanChi(DateTime date) {
    // baseDate là ngày âm, 01/07/2003 là tháng Canh Thân, giá trị trong mảng là: can[0], chi[0]
    DateTime lunarDate =
