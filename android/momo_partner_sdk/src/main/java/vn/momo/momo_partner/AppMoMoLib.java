...
public class AppMoMoLib {
    ...
    String actionType = "";
    public JSONObject dataRequest = null;
    ...
    public void setOrderResponse(Map<String, Object> response){
        orderResponse = response;
        // String token = orderResponse.get("token").toString();
    ...
    public void requestMoMoCallBack(final Activity activity, Map<String, Object> hashMap) {
        ...
        try {
            ...
            jsonData.put("action", "gettoken");
            jsonData.put("partner", "merchant");
            // 
